    ...
    <div class="auth-page">
      <form class="auth-card" (ngSubmit)="submit()">
        ...
        <div class="auth-actions">
          <a routerLink="/web/reset-password">J’ai déjà un code</a>
          <a routerLink="/web/login">Retour à la connexion</a>
        </div>
      </form>
    </div>
  `,
  ...
  submit(): void {
    ...
    this.authService.forgotPassword(this.email).subscribe({
      next: (res) => {
        ...
        this.router.navigate(['/web/reset-password'], { queryParams: { email: this.email } });
