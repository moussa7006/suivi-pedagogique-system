  ...
  template: `
    <nav class="sidebar" [class.mobile-active]="isMobileMenuOpen">
      ...
      <div class="sidebar-logo">
        <img src="/assets/login.jpeg" alt="Logo Suivi Pédagogique" class="logo-img" />
        <span>EduTrack</span>
      </div>
      ...
      <div class="nav-container">
        ...
        <ul class="nav-list">
          <li>
            <a routerLink="/web/dashboard" routerLinkActive="active">
              <i class="pi pi-home"></i>
              <span>Tableau de bord</span>
            </a>
          </li>
          <li>
            <a routerLink="/web/attendance" routerLinkActive="active">
              <i class="pi pi-check-square"></i>
              <span>Émargements</span>
            </a>
          </li>
          <li>
            <a routerLink="/web/qr-generator" routerLinkActive="active">
        ...
        <ul class="nav-list">
          <li *ngIf="isAdmin">
            <a routerLink="/web/classes" routerLinkActive="active">
              <i class="pi pi-users"></i>
              <span>Classes</span>
            </a>
          </li>
          <li>
            <a routerLink="/web/schedule" routerLinkActive="active">
              <i class="pi pi-calendar"></i>
              <span>Emplois du temps</span>
            </a>
          </li>
          <li *ngIf="isAdmin">
            <a routerLink="/web/honoraires" routerLinkActive="active">
              <i class="pi pi-money-bill"></i>
              <span>Honoraires</span>
            </a>
          </li>
          <li *ngIf="isAdmin">
            <a routerLink="/web/matieres" routerLinkActive="active">
              <i class="pi pi-book"></i>
              <span>Matières</span>
            </a>
          </li>
          <li>
            <a routerLink="/web/seances" routerLinkActive="active">
              <i class="pi pi-calendar-times"></i>
              <span>Séances (Sessions)</span>
            </a>
          </li>
          <li *ngIf="isAdmin">
            <a routerLink="/web/teachers" routerLinkActive="active">
        ...
        <ul class="nav-list" *ngIf="isAdmin">
          <li>
            <a routerLink="/web/annees-universitaires" routerLinkActive="active">
          ...
          <li>
            <a routerLink="/web/filieres" routerLinkActive="active">
              <i class="pi pi-sitemap"></i>
              <span>Filières</span>
            </a>
          </li>
          <li>
            <a routerLink="/web/niveaux-enseignement" routerLinkActive="active">
              <i class="pi pi-graduation-cap"></i>
              <span>Niveaux</span>
            </a>
          </li>
          <li>
            <a routerLink="/web/salles" routerLinkActive="active">
        ...
        <ul class="nav-list">
          <li>
            <a routerLink="/web/pedagogy" routerLinkActive="active">
